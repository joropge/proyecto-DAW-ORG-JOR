...
<body class="bg-black text-white font-sans">
        ...
        <div class="header flex justify-between items-center py-2 px-10">
            ...
            <div class="menu flex justify-between items-center">
                <ul class="flex justify-between items-center gap-5 whitespace-nowrap">
                    <li><button id="inicio" class="bg-transparent border-none text-neutral-400 text-md cursor-pointer hover:text-white">Inicio</button>
                    </li>
                    <li><button id="acerca" class="bg-transparent border-none text-neutral-400 text-md cursor-pointer hover:text-white">Acerca
                            de</button></li>
                    <li><button id="contacto" class="bg-transparent border-none text-neutral-400 text-md cursor-pointer hover:text-white">Contacto</button>
                    </li>
                    <li><a href="./templates/login.php" id="login" class="bg-transparent border-none text-neutral-400 text-md cursor-pointer hover:text-white">Iniciar Sesion</a>
                    </li>
                </ul>
    ...
    <div class="content p-10">
        ...
        <!-- Prueba para alvaro -->
        <div class="display grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 items-center py-5" id="display"></div>
    </div>
