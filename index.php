...
<body class="bg-black text-white font-sans">
    <div class="my-0 mx-auto">
            ...
            <div class="menu flex justify-between items-center">
                <ul class="flex justify-between items-center gap-5 whitespace-nowrap">
                    ...
                    <li><button id="acerca"
                            ...
                            de</button></li>
                    <li>
                        <a href="./templates/contacto.php"><button id="contacto"
        ...
        <div class="order flex-col gap-5 bg-white text-black w-96 max-h-[500px] p-5 rounded-md absolute top-20 right-10 z-[100] overflow-y-auto hidden"
            id="order">
            <div id="full-basket" class="hidden">
                ...
                <button id="pagar"
                    class="w-full py-3 border-none rounded-md bg-black text-white text-center cursor-pointer mt-4 font-bold hover:bg-light-gray transition-all duration-200 ease-in-out">Finalizar
                    pedido</button>
            </div>
            <div id="empty-basket">
    ...
    <div class="content p-10">
        ...
        <!-- Prueba para alvaro -->
        <div class="display grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 items-center py-5"
            id="display"></div>
    </div>
